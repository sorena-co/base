...
import ir.sp.base.service.RoomService;
...
public class RoomResourceIntTest {
    ...
    private static final Boolean DEFAULT_HAS_PROJECTOR = false;
    private static final Boolean UPDATED_HAS_PROJECTOR = true;

    private static final Boolean DEFAULT_IS_LAB = false;
    private static final Boolean UPDATED_IS_LAB = true;
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room()
            .name(DEFAULT_NAME)
            .size(DEFAULT_SIZE)
            .hasProjector(DEFAULT_HAS_PROJECTOR)
            .isLab(DEFAULT_IS_LAB);
        return room;
    }
    ...
    public void createRoom() throws Exception {
        ...
        assertThat(testRoom.isHasProjector()).isEqualTo(DEFAULT_HAS_PROJECTOR);
        assertThat(testRoom.isIsLab()).isEqualTo(DEFAULT_IS_LAB);
    }
    ...
    public void getAllRooms() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].hasProjector").value(hasItem(DEFAULT_HAS_PROJECTOR.booleanValue())))
            .andExpect(jsonPath("$.[*].isLab").value(hasItem(DEFAULT_IS_LAB.booleanValue())));
    }
    ...
    public void getRoom() throws Exception {
        ...
        restRoomMockMvc.perform(get("/api/rooms/{id}", room.getId()))
            ...
            .andExpect(jsonPath("$.hasProjector").value(DEFAULT_HAS_PROJECTOR.booleanValue()))
            .andExpect(jsonPath("$.isLab").value(DEFAULT_IS_LAB.booleanValue()));
    }
    ...
    public void updateRoom() throws Exception {
        ...
        updatedRoom
            .name(UPDATED_NAME)
            .size(UPDATED_SIZE)
            .hasProjector(UPDATED_HAS_PROJECTOR)
            .isLab(UPDATED_IS_LAB);
        ...
        assertThat(testRoom.isHasProjector()).isEqualTo(UPDATED_HAS_PROJECTOR);
        assertThat(testRoom.isIsLab()).isEqualTo(UPDATED_IS_LAB);
    }
