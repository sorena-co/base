...
import ir.sp.base.service.RegionService;
...
public class RegionResourceIntTest {
    ...
    private static final String DEFAULT_LVL = "AAAAAAAAAA";
    private static final String UPDATED_LVL = "BBBBBBBBBB";
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getLvl()).isEqualTo(DEFAULT_LVL);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].lvl").value(hasItem(DEFAULT_LVL.toString())));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.lvl").value(DEFAULT_LVL.toString()));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        assertThat(testRegion.getLvl()).isEqualTo(UPDATED_LVL);
    }
